        ...
        <div class="flex flex-col lg:flex-row border-b border-[#2B2F36]">
           ...
           <div class="flex-1 flex flex-col border-r border-[#2B2F36] min-w-0">
              ...
              <div class="h-[450px] w-full relative">
                 <TradeChart :symbol="currentSymbol" pageUri="nbitmx.com/play/futures/trade" />
              </div>
              <!-- Form Area -->
              <FuturesForm class="!h-auto" />
           </div>
...
import FuturesForm from '@/components/trade/forms/FuturesForm.vue'
